<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Edit Sales Rep</h4>
        </div>
        <form action="{{route('salesRep.update', [$data->id])}}" method="post" data-toggle="validator" role="form">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            ...
            <div class="modal-footer">
                <input type="submit" name="add_supplier" value="Update Sales Rep" class="btn btn-primary">
            </div>
        </form>
    </div>
</div>
