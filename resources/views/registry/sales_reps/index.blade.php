                ...
                <ul class="list-inline mb-0 btn-tasks">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                            <a class="dropdown-item" href="{{url('salesRep/create')}}"
                               data-toggle="modal"
                               data-target="#myModal">
                            ...
                            <a class="dropdown-item" href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> Delete Sales Rep
                            </a>
                        </ul>
                    </li>
                </ul>
                            ...
                            @if($rows->total()>0)
                                @foreach ($rows as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <div class=text-center>
                                                <a href="{{url("salesRep/{$row->id}/edit")}}" class='tip'
                                               ...
                                               <a class='btn btn-danger po-delete' href='{{route('salesRep.destroy',[$row->id])}}'>Yes I'm sure</a>
                                                <button class='btn po-close'>No</button>" rel="popover"
                                                   data-original-title="<b>Delete Sales Rep</b>"
