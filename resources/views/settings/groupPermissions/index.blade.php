                ...
                <ul class="list-inline mb-0 btn-tasks">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                            <a class="dropdown-item" href="{{url('group/create')}}"
                               data-toggle="modal"
                               data-target="#myModal">
                        ...
                        <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                            ...
                            @foreach ($rows as $row)
                                <tr>
                                    ...
                                    <td>
                                        <div class=text-center>
                                            <a href="{{url("group/{$row->id}/edit")}}" class='tip'
                                               title='Edit Group'
                                            ...
                                            <a href="javascript:void(0)" class="tip po" title=""
                                               ...
                                               <a class='btn btn-danger po-delete' href='{{route('group.destroy',[$row->id])}}'>Yes I'm sure</a>
                                                <button class='btn po-close'>No</button>" rel="popover"
                                               data-original-title="<b>Delete Warehouse</b>"
