<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add Sales Rep</h4>
        </div>
        <form action="{{url('salesRep')}}" method="post" data-toggle="validator" role="form">
            {{ csrf_field() }}
            ...
            <div class="modal-footer">
                <input type="submit" name="add_supploer" value="Add Sales Rep" class="btn btn-primary">
            </div>
        </form>
    </div>
</div>
