                ...
                <ul class="list-inline mb-0 btn-tasks">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                            <a class="dropdown-item" href="{{url('userGroup/create')}}"
                               data-toggle="modal"
                               data-target="#myModal">
                            ...
                            <a class="dropdown-item" href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> Delete_user_group
                            </a>
                        </ul>
                    </li>
                </ul>
                        ...
                        <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                            ...
                            @foreach ($rows as $row)
                                <tr>
                                    ...
                                    <td>
                                        <div class=text-center>
                                            <a href="{{url("userGroup/{$row->id}/edit")}}" class='tip'
                                            ...
                                            <a href="javascript:void(0)" class="tip po" title=""
                                               ...
                                               <a class='btn btn-danger po-delete' href='{{route('userGroup.destroy',[$row->id])}}'>Yes I'm sure</a>
                                                <button class='btn po-close'>No</button>" rel="popover"
                                               data-original-title="<b>Delete User Group</b>"
