                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                            ...
                            <a class="dropdown-item" href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> Delete Warehouses
                            </a>
                        </ul>
                    </li>
                </ul>
                    ...
                    <div class="table-responsive">
                        <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                            ...
                            <tr>
                                ...
                                <th class="col-xs-1">Category Code</th>
                                <th class="col-xs-2">Category Name</th>
                                <th class="col-xs-2">Parent Category</th>
                            ...
                            @if($rows->total()>0)
                                @foreach ($rows as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <div class=text-center>
                                                <a href="{{url("categories/{$row->id}/edit")}}" class='tip'
                                               ...
                                               <a class='btn btn-danger po-delete' href='{{route('categories.destroy',[$row->id])}}'>Yes I'm sure</a>
                                                <button class='btn po-close'>No</button>" rel="popover"
                                                   data-original-title="<b>Delete Category</b>"
