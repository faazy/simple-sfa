                ...
                <ul class="list-inline mb-0 btn-tasks">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                            <a class="dropdown-item" href="{{url('suppliers/create')}}"
                               data-toggle="modal"
                               data-target="#myModal">
                            ...
                            @if($rows->total()>0)
                                @foreach ($rows as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <div class=text-center>
                                                <a href="{{url("suppliers/{$row->id}/edit")}}" class='tip'
                                               ...
                                               <a class='btn btn-danger po-delete' href='{{route('suppliers.destroy',[$row->id])}}'>Yes I'm sure</a>
